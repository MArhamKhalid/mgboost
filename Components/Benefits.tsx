...
const Benefits = () => {
  ...
  return (
    <section className='w-full h-[130vh] relative flex flex-col justify-center overflow-hidden text-black Benefits' ref={BenefitsRef}>
        ...
        <div className='w-full h-full flex justify-center items-start relative Benefits-Cards'>
