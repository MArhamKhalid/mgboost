...
const Details = () => {
  ...
  return (
    <section className='w-full h-[110vh] bg-white relative 2xs:h-max lg:py-18 lg:px-0 2xs:px-4 2xs:py-10 lg:min-h-dvh lg:h-max details-section' ref={DetailsRef} >
        <div className='w-full lg:h-max xl:px-25 lg:px-15 2xs:px-0 flex 2xs:flex-col lg:flex-row 2xs:gap-y-10 justify-center items-center gap-x-10 z-1 sub-details-section'>
            <div className='2xl:w-240 lg:w-[55%] 2xl:h-220 2xs:w-[100%] 2xs:h-80  bg-gradient-to-t from-[#FFF8E5] to-[#CAF8D4] rounded-[20px] detailimage'>
            ...
            <div className='2xl:w-220 lg:w-[45%] 2xs:w-[100%] 2xl:h-full flex flex-col justify-center lg:gap-y-10 2xs:gap-y-6 detailText'>
                ...
                <div className='2xs:ml-0 ml-14'>
                    ...
                    <button className="2xs:w-[180px] 2xs:h-[46px] 2xl:w-[200px] 2xl:h-[52px] bg-[#DAA404] flex justify-center items-center text-white rounded-[30px] 2xs:text-[18px] xs:text-[18px] 2xl:text-[20px] cursor-pointer font-Albert 2xs:gap-x-8  capitalize">
