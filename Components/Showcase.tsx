...
const Showcase = () => {
  ...
  return () => ctx.revert();
    ...
    return (
        ...
        <section ref={sectionRef} className="relative w-full h-[200vh] bg-white  ">
            <div className="sticky top-0 w-full  h-screen overflow-hidden">
                <div className="scene scene-1 w-full h-screen absolute inset-0 z-10 teanima flex justify-center items-center  bg-white ">
                ...
                <div className="scene scene-2 w-full h-screen absolute inset-0 z-20 px-15 flex gap-x-[32px] text-black bg-white">
                ...
                <div className="scene scene-3 absolute inset-0 z-30 w-full h-screen flex flex-col justify-end  bg-white">
                    <div className="w-full flex justify-center px-25  py-20 gap-x-[32px] text-black">
