  ...
  return (
    <section className='hero w-full h-[90vh]'>
        <div className='w-full h-full flex justify-between items-center px-[100px] relative'>
            <div className='w-full flex flex-col justify-start gap-y-5 z-1'>
                ...
                <div className='capitalize font-Alan text-black leading-[78px]'>
                    <h2 className='text-[50px] font-bold font-Albert'>the smarter way to</h2>
                    <h2 className='text-[87.32px] font-bold'> get magnesium.</h2>
                </div>
                <div className='flex flex-col gap-y-4 font-Albert text-black'>
                    <p className='capitalize font-normal text-[20px]'>MG BOOST is a premium magnesium sparkling drink that supports<br/>calm, focus, digestion, and better sleep</p>
